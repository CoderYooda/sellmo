...
trait ProvideTabFilters
{
     ...
     * @var array
     */
    protected array $customTabFilters = ['type', 'status', 'entity_type', 'duration', 'scheduled'];
     ...
     * @return void
     */
    public function addTabFilter(array $filterConfig): void
    {
     ...
     * @return string
     */
    public function resolveCustomTabFiltersColumn(string $key): string
    {
        switch ($key) {
            case 'duration':
