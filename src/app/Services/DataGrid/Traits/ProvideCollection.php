...
trait ProvideCollection
{
    ...
    public function getCollection(): LengthAwarePaginator|Collection
    {
    ...
    public function formatCollection()
    {
        ...
        /**
         * To Do (@devansh-Bitex): Need to handle from record's column. For this frontend also needs to adjust.
         */
    ...
    /**
     * @param Builder|Collection $queryBuilderOrCollection
     * @return Collection|LengthAwarePaginator
     */
    private function generateResults(Builder|Collection $queryBuilderOrCollection): Collection | LengthAwarePaginator
    {
        if ($this->paginate) {
     ...
     */
    private function paginatedResults(Builder $queryBuilderOrCollection): LengthAwarePaginator
    {
     ...
     * Sort collection.
     *
     * @param Collection|Builder $collection
     * @param array $info
     * @return void
     * @throws \Exception
     */
    private function sortCollection(Collection|Builder $collection, array $info): void
    {
        ...
        if ($countKeys > 1) {
            throw new \Exception('Множественная сортировка');
        }
